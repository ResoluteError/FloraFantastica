...
router.post("/", authorizer_1.Authorizer.IsSimpleAuthorized, MeasurementsController_1.MeasurementController.post);
...
router.delete("/:measurementId", authorizer_1.Authorizer.IsSimpleAuthorized, MeasurementsController_1.MeasurementController.delete);
